<?php
    class Potatoblog extends Controller {
        ...
        public function index($slug = null) {
            ...
            if($slug == null) {
                ...
                $this->view('potatoblog/index', $data);
            } else {
                ...
                $this->view('potatoblog/show', $data);
            }
        }
        ...
        public function create() {
            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if(empty($data['slug_err']) && empty($data['html_err'])) {
                    ...
                    $this->view('potatoblog/create', $data);
                }
        ...
        public function edit($slug){
            ...
            $this->view('potatoblog/edit', $data);
        }
        ...
        public function confirm(){
            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST'){
                ...
                $this->view('potatoblog/confirm', $data);
            } else {
                redirect('potatoblog');
            }
        }
            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST'){
                ...
                if(isset($_SESSION['id'])){
                    ...
                    if(isset($id) && isset($slug) && isset($html)){
                        ...
                        $this->view('potatoblog/complete', $res);
                    }
