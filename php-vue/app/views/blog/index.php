...
<div id="app">
    ...
    <div class="subheader" style="width: 100%">
        <h3>◯◯ | ブログ管理画面</h3>
        <a href="<?php echo URL_ROOT; ?>/blog/create" class="waves-effect waves-light btn"><i class="material-icons left">add_box</i>新規</a>
    </div>
    <table class="striped">
        <thead>
            <tr>
        ...
        <tbody id="blogs">
            ...
            <tr v-for='(blog, r) in blogs' class="align-center">
                ...
                <td class="align-center"><a :href="`<?php echo URL_ROOT; ?>/blog/${blog.slug}`"><i class="material-icons blue-grey-text lighten-4">remove_red_eye</i></a></td>
                <td class="align-center"><a :href="`<?php echo URL_ROOT; ?>/blog/edit/${blog.slug}`"><i class="material-icons">edit</i></a></td>
