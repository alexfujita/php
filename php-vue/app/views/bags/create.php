 ...
 const app = new Vue({
     ...
     methods: {
        ...
        addBag(){
            ...
            if(app.special){
                const start = `${data.start_year}--${data.start_monty}--${data.start_day} ${start_hour}:${start_minute}:00`;
                data.start = start;

                const end = `${data.end_year}--${data.end_monty}--${data.end_day} ${data.end_hour}:${data.end_minute}:00`;
                data.end = end;
            }
