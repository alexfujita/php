    ...
    <div class="row flex-column">
        <form action="<?php echo URL_ROOT; ?>/mtgroom/confirm" method="post">
            ...
            <div class="form-group">
                <label for="slug">ミーティングルーム版: <sup>*</sup></label>
                <input type="text" name="slug" class="form-control form-control-lg <?php echo (!empty($data['slug_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['slug']; ?>" placeholder="例：vol75">
